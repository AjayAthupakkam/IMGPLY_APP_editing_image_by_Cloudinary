...
export async function getImageById(imageId: string) {
  try {
    ...
    // Return a default image object to avoid errors
    return {
      _id: imageId || "default_image_id",
      ...
      secureURL: "/assets/icons/image.svg",
      width: 100,
      height: 100,
      config: {},
      creditFee: 0
...
export async function getUserImages({
  ...
  try {
    ...
    // If userId is default or doesn't exist, return all images
    let query = {};
